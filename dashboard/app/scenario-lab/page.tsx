...
export const metadata = {
  title: "Scenario Lab · Leakproof",
  description: "Clearly synthetic recovery evaluation and regression metrics.",
};
    ...
    <Shell active="scenario">
      <div className="page-wrap">
        <div className="scenario-banner">
          <strong>Scenario Lab · synthetic data only</strong>
          <span>These results come from the fixed-seed simulator. They are not live recovery claims.</span>
        </div>
